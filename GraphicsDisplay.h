...
class GraphicsDisplay: public View {
 ...
 private:
   ...
   Xwindow symbolToColour(const char symbol); //Returns the Xwindow colour correspoinding to the symbol, black otherwise
   void fillCell(const int row, const int col, Xwindow colour); //fills the cell at (row,col) with colour
